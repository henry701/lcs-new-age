...
String mapCCSPlace(Site loc, String placename) {
  return {
        SiteType.upscaleApartment: LcsI18n.tr("University Dormitory"),
        SiteType.barAndGrill: LcsI18n.tr("Gay Nightclub"),
        SiteType.cosmeticsLab: LcsI18n.tr("Animal Shelter"),
        SiteType.geneticsLab: LcsI18n.tr("Research Ethics Commission HQ"),
        SiteType.policeStation: LcsI18n.tr("Police Reform Office"),
        SiteType.courthouse: LcsI18n.tr("Abortion Clinic"),
        SiteType.prison: LcsI18n.tr("Rehabilitation Center"),
        SiteType.intelligenceHQ: LcsI18n.tr("Media Independence Office"),
        SiteType.sweatshop: LcsI18n.tr("Labor Union HQ"),
        SiteType.dirtyIndustry: LcsI18n.tr(
          "Sustainable Energy Research Center",
        ),
        SiteType.nuclearPlant: LcsI18n.tr("Whirled Peas Museum"),
        SiteType.corporateHQ: LcsI18n.tr("Welfare Assistance Agency"),
        SiteType.ceoHouse: LcsI18n.tr("Tax Collection Agency"),
        SiteType.amRadioStation: LcsI18n.tr("Public Radio Station"),
        SiteType.cableNewsStation: LcsI18n.tr("Network News Station"),
        SiteType.armyBase: LcsI18n.tr("Greenpeace Offices"),
        SiteType.fireStation: LcsI18n.tr("ACLU Branch Office"),
        SiteType.bank: LcsI18n.tr("Richard Dawkins Food Bank"),
        SiteType.whiteHouse: LcsI18n.tr("Progressive Lobbying Office"),
      }[loc.type] ??
      placename;
}
