...
Future<void> helpOnActivity(ActivityType type) async {
  ...
  switch (type) {
    case ActivityType.communityService:
      ...
      _body(
        "Community service is a safe way to improve public opinion of the "
    ...
    case ActivityType.trouble:
      ...
      _body(
        "Liberal Disobedience is an occasionally illegal "
    ...
    case ActivityType.graffiti:
      _head("=== Graffiti ===");
      _body(
        "Spraying political graffiti is a misdemeanor, carrying with it "
    ...
    case ActivityType.hacking:
      _head("=== Hacking ===");
      _body(
        "Hacking is a highly illegal form of Liberal Activism, which has "
    ...
    case ActivityType.writeGuardian:
      ...
      _body(
        "The Liberal Guardian is the LCS's media presence. In another era, "
    ...
    case ActivityType.donations:
      ...
      _body(
        "Soliciting donations is a safe way to raise funds for the LCS.  "
    ...
    case ActivityType.sellTshirts:
      _head("=== Sell Clothing ===");
      _body(
        "Selling Clothing is a safe way to raise funds for the LCS. It is "
    ...
    case ActivityType.sellMusic:
      _head("=== Perform Music ===");
      _body(
        "Performing Music is a safe way to raise funds for the LCS. It is "
        "more lucrative when the public is very Conservative, because it's "
        "not about how many people have your back, it's about how radical "
    ...
    case ActivityType.sellArt:
      _head("=== Sell Art ===");
      _body(
        "Selling Art is a safe way to raise funds for the LCS. It is more "
    ...
    case ActivityType.sellDrugs:
      ...
      _body(
        "Selling Brownies on the street is an illegal but rewarding "
    ...
    case ActivityType.prostitution:
      _head("=== Prostitution ===");
      _body(
        "Prostitution is an illegal but rewarding way to make money. "
    ...
    case ActivityType.ccfraud:
      ...
      _body(
        "Credit Card Fraud is an illegal but rewarding way to make money.  "
    ...
    case ActivityType.stealCars:
      _head("=== Stealing Cars ===");
      _body(
        "Stealing a car will have the Liberal attempt to steal a car from "
    ...
    case ActivityType.bury:
      ...
      _body(
        "Bodies piling up generates a lot of heat. Taking some time to "
    ...
    case ActivityType.clinic:
      ...
      _body(
        "Injuries can be healed slowly at home, but for anything serious "
    ...
    case ActivityType.makeClothing:
      ...
      _body(
        "Tailoring skill is used to make clothing and armor. The first "
    ...
    case ActivityType.wheelchair:
      ...
      _body(
        "Wheelchairs are used to help the disabled get around. If you "
        "have this option available, you need one.",
      );
    case ActivityType.recruiting:
      _head("=== Recruit ===");
      _body(
        "Recruiting is a safe way to meet people of a specific job.  Not "
    ...
    case ActivityType.takeClass:
      _head("=== Take Classes ===");
      _body(
        "Taking a class is faster than practicing, but it costs money and "
    ...
    case ActivityType.teachLiberalArts:
      _head("=== Teaching ===");
      _body(
        "Teaching is a way to pass on your skills to others. Every LCS "
    ...
    case ActivityType.visit:
      _head("=== Site Visit ===");
      _body(
        "Liberals acting with their squad to visit a location will not "
        "be able to do anything else that day.",
      );
    case ActivityType.interrogation:
      _head("=== Interrogation ===");
      _body(
        "You're trying to do what? Yeah, I don't know. Interrogating "
...
Future<void> helpOnSitemode() async {
  ...
  _head("=== Direct Action ===");
  _body(
    "You are taking direct action against the Conservative Menace.\n\n"
