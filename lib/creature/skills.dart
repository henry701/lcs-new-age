...
enum Skill {
  ...
  dodge(
    Attribute.agility,
    "Dodge",
    "Avoid attacks. Utilize cover.",
    classText: "Master dancing. Move like water.",
  ),
  driving(
    Attribute.agility,
    "Driving",
    "Race cars without crashing. Do stunts.",
  ...
  law(
    Attribute.intelligence,
    "Law",
    "Understand the law. Defend yourself.",
  ...
  religion(
    Attribute.intelligence,
    "Religion",
    "Understand and manipulate faith.",
  ...
  throwing(
    Attribute.agility,
    "Throwing",
    "Throw a molotov. Or other things.",
    canTakeClasses: false,
  ),
  writing(
    Attribute.intelligence,
  ...
  seduction(
    Attribute.heart,
    "Seduction",
    "Make others want you, then satisfy them.",
    canTakeClasses: false,
  );
