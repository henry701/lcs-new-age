...
Future<bool> talkAboutIssues(Creature a, Creature tk) async {
  Law lw = _discussionPoints.keys
      .toList()
      .random; // pick a random law to talk about
  ...
  if (succeeded && tk.name != "Prisoner") {
    ...
    if (tk.type.id == CreatureTypeIds.mutant &&
      ...
      switch (lcsRandom(10)) {
        case 0:
          addstr("Dear me! Is there anything we can do?", params: {});
        case 1:
          addstr("That *is* disturbing!   What can I do?", params: {});
        case 2:
          addstr("Gosh!   Is there anything I can do?", params: {});
        case 3:
        ...
        case 5:
          addstr("Oh my Science!   We've got to do something!", params: {});
        case 6:
