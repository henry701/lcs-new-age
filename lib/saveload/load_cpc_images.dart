...
List<List<List<List<int>>>> readCPCData(ByteData h, [int pos = 0]) {
  ...
  return List.generate(
    ...
    (p) => List.generate(
      ...
      (x) => List.generate(
        dimy,
        (y) => List.generate(4, (z) => h.getUint8(pos++), growable: false),
        growable: false,
      ),
      growable: false,
    ),
...
Color translateGraphicsColor(
  int c,
  bool bright, {
  bool remapSkinTones = false,
  Color? remapLightGray,
}) => switch ((c, bright)) {
  (0, true) => darkGray,
  (0, false) => black,
  (1, true) => blue,
...
void drawCPCGlyph(
  ...
  Color fgColor = translateGraphicsColor(
    glyph[1],
    bright,
    remapSkinTones: remapSkinTones,
    remapLightGray: remapLightGray,
  );
  Color bgColor = translateGraphicsColor(
    glyph[2],
    false,
    remapSkinTones: remapSkinTones,
    remapLightGray: remapLightGray,
